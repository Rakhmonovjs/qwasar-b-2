class BucketsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bucket.save
        format.html { redirect_to project_bucket_url(@bucket.project,@bucket), notice: "Bucket was successfully created." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to project_buckets_url(@bucket.project), notice: "Bucket was successfully destroyed." }
  ...
  private
    ...
    def bucket_params
      params.require(:bucket).permit(:name, :project_id)
    end
end
